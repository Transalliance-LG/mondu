    ...
    <div>
          ...
          <div className="md:col-start-1 md:col-end-2 z-40 mt-[32px] mb-[0px]">
            <div className="">
              <div>
                ...
                <button className=" flex text-white bg-primary  items-center text-[12px] md:text-[16px] font-semibold mt-[43px] z-40 px-[18px] py-[12px] rounded-[30px] md:px-[30px]">
                  Explore the Docs
      ...
      <div className="bg-primary py-[48px] lg:py-[64px] xl:px-[150px] 2xl:px-[150px] lg:px-[90px] px-[15px] md:px-[30px] xl:grid grid-cols-2 lg:gap-[30px] gap-[20px] items-center">
        ...
        <div className="sm:grid sm:grid-cols-3  2xl:mx-[70px] mt-[16px] xl:mt-[0px]">
          ...
          />
          <button className=" py-[12px] px-[16px] col-start-3 col-end-4 bg-cyan-600 text-white rounded-r-[6px] rounded-l-[6px] sm:rounded-l-[0px] w-full sm:w-auto mt-[16px] sm:mt-[0px]">
            Create an account
          </button>
        </div>
      </div>
